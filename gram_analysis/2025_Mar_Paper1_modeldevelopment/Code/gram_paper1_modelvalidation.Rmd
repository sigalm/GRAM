...
setwd(dirname(dirname(dirname(getwd()))))
# saveRDS(sim_calib, "gram_analysis/2025_Mar_Paper1_modeldevelopment/Code/sim_calib_20250904_111500x.RDS")
...
figure3_fig_60plus <- figure3 + scale_x_discrete(limits = setdiff(levels(figure3_dat$dat$age_group), c("50-54", "55-59", "Overall_adj")))

ggsave("../Figures/figure3_60plus.pdf", plot = figure3_fig_60plus, 
       width = 10, height = 6, dpi = 300)
```
